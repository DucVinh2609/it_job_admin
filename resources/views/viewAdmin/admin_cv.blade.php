...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <form action="{!! url('/api/admin_cv/') !!}" method="get" class="search-form" pjax-container>
        ...
        <section class="content">
            ...
            <div class="row"><div class="col-md-12"><div class="box">
                <div class="box-header with-border">
                    <div class="pull-right">
                        ...
                        <div class="btn-group pull-right" style="margin-right: 10px">
                            <a href="{!! url('/api/admin_cv/add') !!}" class="btn btn-sm btn-success" title="New">
                ...
                <div class="box-header with-border hide" id="filter-box">
                    <form action="{!! url('/api/admin_cv/') !!}" class="form-horizontal" pjax-container method="get">
