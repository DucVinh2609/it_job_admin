...
<head>
    ...
    <title>IT-Jobs Admin  | Add Employer Detail</title>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{!! url('/api/admin_employer_detail/') !!}" class="btn btn-sm btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{!! url('/api/admin_employer_detail/add') !!}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txt_IDEmployer" value="" class="form-control name" placeholder="Input ID Employer" />
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea name="txt_Address" class="form-control comment" rows="3" placeholder="Input Address" autofocus ></textarea>
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="Amount_of_people" class="col-sm-2  control-label">Employees</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="width: 85px" type="text"  name="txt_Employees" value="" class="form-control price"  />
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txt_Country" value="" class="form-control name" placeholder="Input Country" />
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="Title" class="col-sm-2  control-label">Woking Time</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txt_WokingTime" value="" class="form-control name" placeholder="Input Woking Time" />
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="requirement" class="col-sm-2  control-label">Overview</label>

                                <div class="col-sm-8">


                                    <textarea name="txt_Overview" class="form-control comment" rows="10" placeholder="Input Requirement" autofocus ></textarea>
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txt_Website" value="" class="form-control name" placeholder="Input Woking Time" />
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="Title" class="col-sm-2  control-label">Link Facebook</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txt_LinkFacebook" value="" class="form-control name" placeholder="Input Woking Time" />
