...
<head>
    ...
    <title>IT-Jobs Admin  | Add Skill</title>
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            <div class="row"><div class="col-md-12"><div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{!! url('/api/admin_skill/add') !!}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="Title" class="col-sm-2  control-label">Name Skill</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txtNameSkill" value="" class="form-control name" placeholder="Input Name Skill" />
