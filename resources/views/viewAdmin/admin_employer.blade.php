                ...
                <div class="box-header with-border">
                    <div class="pull-right">
                        ...
                        <div class="btn-group pull-right" style="margin-right: 10px">
                            <a href="{!! url('/api/admin_employer/add') !!}" class="btn btn-sm btn-success" title="New">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td >
                                    <a href="{{route('geteditEmployer',$employers['id'])}}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{route('getdeleteEmployer',$employers['id'])}}"  class="grid-row-delete">
