...
<head>
    ...
    <title>IT-Jobs Admin  | Edit Employer Detail</title>
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            <div class="row"><div class="col-md-12"><div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{!! url('/api/admin_employer_detail/edit',$data['id']) !!}"  enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_IDEmployer', $data->id_employer, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   {!! Form::textarea('txt_Address', $data->address, array('class' => 'form-control comment', 'rows' => 3)) !!}
                           ...
                           <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_Employees', $data->employees, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_Country', $data->country, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_WokingTime', $data->woking_time, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    {!! Form::textarea('txt_Overview', $data->overview, array('class' => 'form-control comment', 'rows' => 10)) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_Website', $data->website, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_LinkFacebook', $data->link_facebook, array('class' => 'form-control name')) !!}
