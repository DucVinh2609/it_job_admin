...
<head>
    ...
    <title>IT-Job Admin  | Edit Candidate</title>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{!! url('/api/admin_candidate/') !!}" class="btn btn-sm btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{!! url('/api/admin_candidate/edit',$data['id']) !!}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txt_CadidateName', $data->name, array('class' => 'form-control name')) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="file" class="image"  name="CandidateCV" value="{!! old('CandidateCV',isset($data)? $data['CV']: null) !!}" />
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::textarea('txt_CandidateCoverLetter', $data->cover_letter, array('class' => 'form-control comment', 'rows' => 5)) !!}
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="file" class="image"  name="CandidateImage" value="{!! old('CandidateImage',isset($data)? $data['image']: null) !!}" />
