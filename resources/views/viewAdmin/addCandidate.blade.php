...
<head>
    ...
    <title>IT-Job Admin  | Candidate</title>
        ...
        <section class="content">
            ...
            <div class="row"><div class="col-md-12"><div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Create Candidate</h3>

                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{{ route('admin_candidate')}}" class="btn btn-sm btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{!! url('/api/admin_candidate/add') !!}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="en__name" name="txt_CandidateName" value="" class="form-control en__name" placeholder="Input Name" />
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="file" class="image" name="CandidateCV"  />
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="en__description" class="col-sm-2  control-label">Cover letter</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="en__description" name="txt_CandidateCoverLetter" value="" class="form-control en__description" placeholder="Input Cover letter" />
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="image" class="col-sm-2  control-label">Imager</label>

                                <div class="col-sm-8">


                                    <input type="file" class="image" name="CandidateImage"  />
