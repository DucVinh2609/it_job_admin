...
<head>
    ...
    <title>IT-Jobs Admin  | Edit Skill</title>
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            <div class="row"><div class="col-md-12"><div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{!! url('/api/admin_skill/edit',$data['id']) !!}"  enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('txtNameSkill', $data->name, array('class' => 'form-control name')) !!}
